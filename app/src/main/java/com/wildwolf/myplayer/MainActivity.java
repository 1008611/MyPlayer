...
import com.wildwolf.myplayer.ui.view.MainView;
import com.wildwolf.myplayer.utils.EventUtil;
import com.wildwolf.myplayer.utils.PreUtils;
import com.wildwolf.myplayer.utils.ThemeUtils;
    ...
    public void onBackPressed() {
        if (mainView.getResideLayout().isOpen()) {
            ...
            if (secondTime - firstTime > 1500) {
                EventUtil.showToast(this, "再按一次要说拜拜了");
